Feature: Validação da exibição de ganhos dos entregadores
  ...
  Scenario: Aumento da taxa de entrega devido a condições climáticas adversas
    Given a API de ganhos está disponível
    And a cidade "São Paulo" tem clima adverso
    When um usuário solicita os ganhos do entregador "E6"
    Then o valor exibido na UI deve ser aumentado em 10%
